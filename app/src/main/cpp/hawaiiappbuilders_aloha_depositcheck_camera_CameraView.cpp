#include "hawaiiappbuilders_aloha_depositcheck_camera_CameraView.h"
...
JNIEXPORT void JNICALL Java_hawaiiappbuilders_aloha_depositcheck_camera_CameraView_decode(
