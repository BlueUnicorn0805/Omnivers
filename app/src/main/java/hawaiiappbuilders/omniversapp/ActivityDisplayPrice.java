...
public class ActivityDisplayPrice extends BaseActivity implements HttpInterface, View.OnClickListener {

    private String TAG = ActivityDisplayPrice.class.getSimpleName();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.pay_amount:
                Intent intent = new Intent(ActivityDisplayPrice.this, ActivityPaymentSuccessfull.class);
