...
public class FetchPlaceTask extends AsyncTask<Void, Void, String> {
        ...
        try {
            ...
            if (addresses.size() > 0 && addresses.get(0) != null) {
                ...
                if (mIsAddressRequired)
                    return getCompleteAddress(mAddress);
                else
                    return getLocality(mAddress);
    ...
    protected void onPostExecute(String s) {
        ...
        if (mListener != null)
            mListener.onAddressParsed(s, mAddress);
    }
    ...
    public interface AddressParseListener {
        void onAddressParsed(String addressString, Address address);
    }
