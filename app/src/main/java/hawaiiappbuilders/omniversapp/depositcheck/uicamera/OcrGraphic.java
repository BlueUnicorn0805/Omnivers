package hawaiiappbuilders.omniversapp.depositcheck.uicamera;
...
import hawaiiappbuilders.omniversapp.depositcheck.DocumentScannerActivity;
...
public class OcrGraphic extends GraphicOverlay.Graphic {
    ...
    public void draw(final Canvas canvas) {
        ...
        DocumentScannerActivity oca = new DocumentScannerActivity();
        tblock = oca.getBlock();
        oca.detectTexts(text.getValue());
