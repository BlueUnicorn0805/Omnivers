...
public class ServiceAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ServiceAdapter(Context ctx, ArrayList<Restaurant> restList, IndustryInfo industryItem, ImageLoader imageLoader, DisplayImageOptions imageOptions) {
    ...
    class RestMenuViewHolder extends RecyclerView.ViewHolder {
        ...
        public RestMenuViewHolder(View itemView) {
            ...
            imgPlaceholder = (ImageView) itemView.findViewById(R.id.bannerPlaceholder);
        }
