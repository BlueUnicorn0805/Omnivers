...
public class ActivityScanQRCodeFTFRequest extends BaseActivity implements View.OnClickListener {

    private static final String TAG = ActivityScanQRCodeFTFRequest.class.getSimpleName();
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (qrcodeString.toLowerCase().contains("Name".toLowerCase())
                            ...
                            Intent intent = new Intent(mContext,ActivityDisplayPriceFTFRequest.class);
