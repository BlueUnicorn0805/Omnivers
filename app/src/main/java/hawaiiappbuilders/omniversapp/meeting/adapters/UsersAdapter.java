package hawaiiappbuilders.omniversapp.meeting.adapters;
...
import hawaiiappbuilders.omniversapp.meeting.listener.UsersListener;
...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.UserViewHolder>{
    ...
    class UserViewHolder extends RecyclerView.ViewHolder {
        ...
        void setUserData(User user) {
            ...
            textEmail.setText(user.firstName + " " + user.lastName);
