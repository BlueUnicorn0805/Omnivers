...
public class ActivityPartyHistory extends BaseActivity implements View.OnClickListener {
    public static final String TAG = ActivityPartyHistory.class.getSimpleName();
    Context context;
