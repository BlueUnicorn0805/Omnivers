...
public class SendPushTaskToUPD extends AsyncTask<String, Void, String> {
    ...
    public SendPushTaskToUPD(ArrayList<String> deviceIdList, int pushType, String title, String message, JSONObject additionalData) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            if (pushType == 1) {
                jNotification.put("click_action", "eAppBuilder1957.c.bid_accept_ACTIVITY");
            } else if (pushType == 2) {
