...
public class SendLocationPushTask extends AsyncTask<String, Void, String> {
    ...
    public SendLocationPushTask(ArrayList<String> deviceIdList, String title, String message, JSONObject additionalData) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            // jNotification.put("appid", "CNXT");
            jNotification.put("title", title);
            jNotification.put("body", message);
            jNotification.put("click_action", "hawaii_location_ACTIVITY");
        ...
        for (String device : deviceList) {
            try {
                try {
                    ...
                    jGcmData.put("data", additionalData);
