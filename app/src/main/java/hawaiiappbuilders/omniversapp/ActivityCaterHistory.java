...
public class ActivityCaterHistory extends BaseActivity implements View.OnClickListener {
    public static final String TAG = ActivityCaterHistory.class.getSimpleName();
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cater_history);
        dataUtil = new DataUtil(this, ActivityCaterHistory.class.getSimpleName());
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        toolbar.setTitle("My Caterings");
    ...
    private void getData() {
        if (getLocation()) {
            try {
                ...
                if (dataUtil!=null) {
                    dataUtil.setActivityName(ActivityCaterHistory.class.getSimpleName());
